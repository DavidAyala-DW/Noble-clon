...
export default function Contact(props) {
  ...
  const selectedLocation = useMemo(
    () => locations.find((l) => l.query.title === location)?.query,
    [locations, location]
  );
    ...
    <div className="flex flex-col pt-[140px] md:pt-[189px] vw:pt-[9.843vw]">
        ...
        <div className="flex flex-col px-4 space-y-5 md:space-y-0 md:flex-row w-full md:max-w-[900px] mx-auto">
          ...
          {locations.map((loc) =>
            <button
              ...
              `}
              onClick={e => handleClick(e, loc.query.title)}
            >
              {loc.query.title}
            </button>
          )}
      ...
      >
        ...
        <div className="flex flex-col space-y-[30px] md:space-y-0 md:grid md:grid-cols-[51%_calc(49%-44px)] md:gap-x-[44px] md:gap-y-7 lg:flex lg:flex-row lg:space-x-[22px] vw:space-x-[1.1458vw] w-max md:mx-auto mb-20 vw:mb-[4.1666vw]">
          ...
          <Checkbox {...{ activeOption }} {...{ setActiveOption }} text="Events Inquiry" id="events_inquiry" />
        </div>
        ...
        >
          ...
          <div className="flex flex-col max-w-max mx-auto gap-4">
            ...
            {selectedLocation && (<div className='text-center text-lg'>
              <p>{selectedLocation.phoneNumber}</p>
              <p>{selectedLocation.address}</p>
              <p>{location}, {selectedLocation.postalCode}</p>
            </div>)}
